                            ...
                            <div class="col-lg-4">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="loginadmin" action="<?= base_url('loginadmin'); ?>" method="POST">
                                        <form>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="admin_id" name="admin_id" type="text" placeholder="Username" required autofocus/>
                                                <label for="inputId">Username</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="password" name="admin_password" type="password" placeholder="Password" required/>
